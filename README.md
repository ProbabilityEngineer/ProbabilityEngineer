...
Building local-first AI systems, agent frameworks, and experimental tooling.
...
- **pi-models-qwen-coding - pi mono and oh-my-pi qwen coding plan endpoint config (original work)**
